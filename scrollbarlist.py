...
class ScrollbarList(ctk.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.scrollbar_label = ctk.CTkLabel(self, text="Your images", font=ctk.CTkFont(size=20, weight="bold"))
        self.scrollbar_label.grid(row=0, column=0, padx=20, pady=20, sticky="nswe")
        ...
        self.canvas_frame = self.canvas.create_window((0, 0), window=self.inner_frame, anchor="center")
    ...
    def add_image(self, image):
        self.images_list.append(ctk.CTkButton(self.inner_frame, corner_radius=0, border_spacing=5, text=image,
