...
class Menu(ctk.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.menu_button_4 = MenuItem(self, text="Add to scrollbar", light_image="./assets/icons8-add-new-48.png",
                                      dark_image="./assets/icons8-add-new-dark-mode-48.png", command=self.root.addToScrollbar, fg_color="transparent")
        ...
        self.menu_button_5 = MenuItem(self, text="Remove from scrollbar", light_image="./assets/icons8-trash-can-48.png",
                                      dark_image="./assets/icons8-trash-can-dark-mode-48.png", command=self.root.removeFromScrollbar, fg_color="transparent")
