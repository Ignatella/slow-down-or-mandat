...
class Menu(ctk.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.logo_label = ctk.CTkLabel(self, text="Menu", font=ctk.CTkFont(size=20, weight="bold"))
        ...
        self.appearance_mode_optionmenu = ctk.CTkOptionMenu(self, values=["Light", "Dark"], command=self.change_appearance_mode_event)
